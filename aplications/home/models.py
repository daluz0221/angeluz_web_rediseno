...
class InfoHome(models.Model):
    ...
    whatsapp = models.CharField(max_length=200, verbose_name='whatsapp', blank=True, null=True)
    textoWhatsapp = models.CharField(max_length=200, verbose_name='Texto de whatsapp', blank=True, null=True)
